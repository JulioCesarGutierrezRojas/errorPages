...
class CustomUserCreationForm(UserCreationForm):
    class Meta:
        ...
        def clean_email(self):
            ...
            # Validar que el correo tenga el dominio @utez.edu.mx
        ...
        def clean_control_number(self):
            ...
            # Validar que la matrícula tenga 10 caracteres y siga el formato de la UTEZ
        ...
        def clean_password1(self):
            ...
            # Validar que la contraseña cumpla con los requisitos de formato
